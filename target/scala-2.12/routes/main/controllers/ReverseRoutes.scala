...
package controllers {
  ...
  class ReverseHomeController(_prefix: => String) {
    ...
    def signInPage(): Call = {
      ...
      Call("GET", _prefix + { _defaultPrefix } + "signInPage")
    }
    ...
    // @LINE:12
    def search(s:String = "a"): Call = {
      
      Call("GET", _prefix + { _defaultPrefix } + "search" + play.core.routing.queryString(List(if(s == "a") None else Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("s", s)))))
    }
    ...
    // @LINE:21
    def removeFromFavourite(a:String = "a"): Call = {
      
      Call("GET", _prefix + { _defaultPrefix } + "removeFromFavourite" + play.core.routing.queryString(List(if(a == "a") None else Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("a", a)))))
    }
    ...
    // @LINE:22
    def deleteFromOutfit(): Call = {
      
      Call("GET", _prefix + { _defaultPrefix } + "deleteFromOutfit")
    }
